...
**Licensed Work:** The ai-triangle reference widget. The Licensed Work is the contents of the
`widget/` and `tools/` directories of the ai-triangle repository. The Licensed Work is
(c) 2026 Brian Rain.

**Additional Use Grant:**

You may make production use of the Licensed Work to embed the self-assessment widget on a
website, in an internal application, or in a document, for your own individual practice, for
your own organization's internal use including at a for-profit company, and for teaching at
an accredited educational institution.

The Licensor claims no rights in the results the Licensed Work produces. The Licensed Work
stores nothing and transmits nothing, and the ratings you or your readers put into it are
yours.

This grant does not extend to providing the Licensed Work, or a derivative of it, to third
parties as a hosted service, a product, a paid or bundled tool, or as a component of a paid
course, training, coaching or consulting offering.

**Change Date:** 2029-09-20

**Change License:** Apache License, Version 2.0

For information about alternative licensing arrangements for the Licensed Work, see
COMMERCIAL-LICENSE.md.

## Terms

The Licensor hereby grants you the right to copy, modify, create derivative works,
redistribute, and make non-production use of the Licensed Work. The Licensor may make an
Additional Use Grant, above, permitting limited production use.
...
as described in this License, you must purchase a commercial license from the Licensor, its
affiliated entities, or authorized resellers, or you must refrain from using the Licensed
Work.
...
to refer to it using the trademark "Business Source License", as long as you comply with the
...
1. To specify as the Change License the GPL Version 2.0 or any later version, or a license
   ...
   software provided under the Change License can be included in a program with software
   provided under GPL Version 2.0 or a later version. Licensor may specify additional Change
   Licenses without limitation.

2. To either: (a) specify an additional grant of rights to use that does not impose any
   additional restriction on the right granted in this License, as the Additional Use Grant;
   or (b) insert the text "None".
